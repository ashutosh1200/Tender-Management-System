        ...
        <div class="container" >
            <div class="navbar-header"> <!-- Header navigation-->
                <a href="#" class="pull-left">
                    <img src="images/TACT.jpg" class="img-responsive img-circle pull-right" style="width:105px;height:130px;"alt="" title="Mr. Manjusa Barman"" alt="HIT Haldia" width="70px" height="70px"/>
                </a>
                    <a class="navbar-brand" href="#"><h1>Tender Management System</h1></a> <!-- Library Name fixed-->
                    <a href="#"><p> A TACT Project</p></a>
            </div>
